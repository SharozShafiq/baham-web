...
<<<<<<< HEAD
from baham.models import Vehicle, VehicleModel,Contract

=======
from baham.models import Vehicle, VehicleModel
>>>>>>> 7f216330e7d2fb8a41c503e78e803b906cd1744a
...
<<<<<<< HEAD
    ...
    def test_vehicle_status_full_when_contracts_reach_seating_capacity(self):
        # Create a Vehicle instance with a seating capacity of 5
        vehicle = Vehicle(seating_capacity=5)

        # Add 4 Contracts to the Vehicle
        for _ in range(4):
            vehicle.add_contract(Contract())

        # At this point, the VehicleStatus should not be FULL
        self.assertNotEqual(vehicle.vehicle_status, 'FULL')

        # Add one more Contract to reach the seating capacity
        vehicle.add_contract(Contract())

        # Now, the VehicleStatus should be FULL
        self.assertEqual(vehicle.vehicle_status, 'FULL')
=======
